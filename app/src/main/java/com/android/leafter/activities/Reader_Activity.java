...
public class Reader_Activity extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (filename!=null) {
            ...
            if (getSharedPreferences(Book_List_Activity.prefname, Context.MODE_PRIVATE).edit().putBoolean(READEREXITEDNORMALLY, false).commit()) {
    ...
    private static class LoaderTask extends AsyncTask<Void,Integer,Book> {
        ...
        private final WeakReference<Reader_Activity> ractref;

        LoaderTask(Reader_Activity ract, File file) {
            this.file = file;
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Reader_Activity ract = ractref.get();
            if (ract!=null) {
...
//        findViewById(R.id.fullscreen_no_button).setVisibility(View.GONE);
    ...
    protected void onPause() {
        ...
        if (exception==null) {
            ...
            getSharedPreferences(Book_List_Activity.prefname, Context.MODE_PRIVATE).edit().putBoolean(READEREXITEDNORMALLY, true).apply();
        }
        super.onPause();
    }
...
//    }
    ...
    private void setNoAwake() {
        try {
            Window w = Reader_Activity.this.getWindow();
...
//            }
            ...
            Reader_Activity.this.getWindow().setBackgroundDrawable(null);
            webView.setBackgroundColor(color);
            Reader_Activity.this.getWindow().setBackgroundDrawable(new ColorDrawable(color));
