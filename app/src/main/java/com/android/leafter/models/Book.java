...
import com.android.leafter.models.extensions.Txt;
...
public abstract class Book {
    ...
    protected abstract Metadata getMetaData() throws IOException;
    ...
    public static void remove(Context context, File file) {
        try {
            FileAPI.deleteDir(getBookDir(context, file));
            String fname = getProperFName(context, file);
    ...
    public boolean remove() {
        FileAPI.deleteDir(getThisBookDir());
        return data.edit().clear().commit();
    }

    protected File getThisBookDir() {
        return thisBookDir;
    }
    ...
    public static Book getBookHandler(Context context, String filename) throws IOException {
        ...
        if (filename.toLowerCase().endsWith(".epub")) {
            book = new Epub(context);
        } else if (filename.toLowerCase().endsWith(".txt")) {
            book = new Txt(context);
        } else if (filename.toLowerCase().endsWith(".html") || filename.toLowerCase().endsWith(".htm")) {
            book = new Html(context);
        }
    ...
    public static Metadata getMetaData(Context context, String filename) throws IOException {
